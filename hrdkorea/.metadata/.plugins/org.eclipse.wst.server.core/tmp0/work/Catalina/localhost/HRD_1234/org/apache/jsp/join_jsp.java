 ...
 * Generated at: 2024-10-25 01:30:06 UTC
...
public final class join_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/layout/footer.jsp", Long.valueOf(1729751838470L));
    _jspx_dependants.put("/layout/header.jsp", Long.valueOf(1729757813090L));
  }
...
String fmtToday = todayTime.format(formatter);
      ...
      out.write("}\r\n");
      out.write("tr{background-color:pink;}\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
      ...
      out.write("nav>ul>li{padding:0 20px;}\r\n");
      ...
      out.write("/proc/joinProc.jsp\" method=\"post\" name=\"joinForm\"\r\n");
      out.write("				onSubmit=\"return false\">\r\n");
      out.write("				<table border=\"1\" align=\"center\" width=\"800px\" >\r\n");
      out.write("					<caption>\r\n");
      out.write("						<h2>쇼핑몰 회원등록</h2>\r\n");
      out.write("					</caption>\r\n");
      out.write("					\r\n");
      out.write("					<tr>\r\n");
      out.write("						<th>회원번호(자동발생)</th>\r\n");
      out.write("						<td><input type=\"text\" name=\"custno\" value=\"");
      out.print(maxCustno + 1);
      out.write("\" /></td>\r\n");
      out.write("					</tr>\r\n");
      out.write("					<tr>\r\n");
      ...
      out.write("							<button onclick=\"reqJoin()\">등록</button>\r\n");
      ...
      out.write("			if (isValid(form))\r\n");
      out.write("				form.submit(); //알림 울려주는 메서드\r\n");
      out.write("		\r\n");
      out.write("		}\r\n");
      out.write("\r\n");
      out.write("		function isValid(form) {\r\n");
      out.write("\r\n");
      out.write("			if (form.custname.value.trim() == \"\") {\r\n");
      out.write("				alert(\"회원이 아닙니다\");\r\n");
      out.write("				form.custname.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("\r\n");
      out.write("			if (form.phone.value.trim() == \"\") {\r\n");
      out.write("				alert(\"전화번호가 입력되지 않았음.\");\r\n");
      out.write("				form.phone.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("			if (form.address.value.trim() == \"\") {\r\n");
      out.write("				alert(\"주소가 입력되지 않았음.\");\r\n");
      out.write("				form.address.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("\r\n");
      out.write("			if (form.joindate.value.trim() == \"\") {\r\n");
      out.write("				alert(\"날짜가 입력되지 않았음.\");\r\n");
      out.write("				form.joindate.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("\r\n");
      out.write("			if (form.grade.value.trim() != \"A\" && form.grade.value.trim() != \"B\" && form.grade.value.trim() != \"C\") {\r\n");
      out.write("				alert(\"등급이 입력되지 않았음.\");\r\n");
      out.write("				form.grade.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("			if (form.city.value.trim() == \"\") {\r\n");
      out.write("				alert(\"도시가 입력되지 않았음.\");\r\n");
      out.write("				form.city.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
