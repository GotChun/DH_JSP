...
<%@ page import="dto.*,utils.*,java.time.*,java.time.format.*,java.util.*"%>
...
String fmtToday = todayTime.format(formatter);
...
<body>
	...
	<div class="wrapper">
		...
		<section>
			<form action="${pageContext.request.contextPath}/proc/joinProc.jsp" method="post" name="joinForm"
