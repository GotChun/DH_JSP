...
<body>
    <div class="container">
        ...
        <!-- playerIdParam이 null이 아니고 record가 null이 아닐 때만 결과를 표시 -->
        <% if (playerIdParam != null && !playerIdParam.isEmpty() && record != null) { %>
            <table border="1">
                <tr><th>선수 ID</th><td><%= record.getPlayerId() %></td></tr>
                <tr><th>선수 이름</th><td><%= record.getPlayerName() %></td></tr>
        ...
        <% } else if (playerIdParam != null && !playerIdParam.isEmpty()) { %>
