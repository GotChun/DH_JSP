...
<body>
	<div class="container">
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					...
					href="<%=request.getContextPath()%>/controller/procPlayer/deletePlayer.jsp?id=<%=player.getPlayerId()%>"
		...
		<!-- 새로운 선수 입력 링크 -->
		<a href="addPlayer.jsp" class="new-link">새로운 선수 입력하기</a> <a
			href="<%=request.getContextPath()%>/index.jsp" class="back-to-home">홈으로</a>
