...
public class MemberDbUtils {
	...
	public static PreparedStatement pstmt; // �̷��� �� �⺻������ �ܿ�� �־���� ;; ���ͳ��� �ȵ� ��������
	...
	public static void insert(MemberDto dto) throws Exception{
		...
		pstmt.setDate(5, Date.valueOf(dto.getJoindate())); //Date.valueOf = date ���� �ٲ��ش� �ڷ����� ���� ?
	...
	public static void update(MemberDto dto) throws Exception{
		...
		pstmt.setDate(4, Date.valueOf(dto.getJoindate())); //Date.valueOf = date ���� �ٲ��ش� �ڷ����� ���� ?
