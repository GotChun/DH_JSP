	...
	<div class="wrapper">
		...
		<main  class="layout" style="">
				...
				<form style="width:400px" action="${pageContext.request.contextPath}/book/add" method="post">
					...
					<div>	
						<a href="${pageContext.request.contextPath }/book/update?bookCode=${bookDto.bookCode}" class="btn btn-success m-2">도서수정</a>
						<a href="${pageContext.request.contextPath }/book/delete?bookCode=${bookDto.bookCode} class="btn btn-success m-2">도서삭제</a>
